...
The following is the development roadmap for AhuM:

#### ✅ Completed Features

**1. Initialize an Ahu Project Structure**
- Basic directories generation
- Basic `config.json` generation
- Basic `config.go` generation
- `go mod init` at the end
- `go mod tidy` at the end

**2. Initializing Infrastructures**
- Form list to choose infrastructures
- Run registered infrastructure forms
- Inject infrastructure configurations to `config.json`
- Inject infrastructure configuration loadings to `config.go`
- Basic infrastructure files generation

**3. Create an Ahu Service**
- Chain layer generation
- Service layer generation
- Data layer generation

**4. Create an Ahu Edge**
- Gin (REST API) support
- Connect (gRPC-Web) support
  - Generate Connect files
  - Service/version/method management
...
- GORM GEN integration
  - Database to struct conversion
  - Dynamic SQL support
  - DAO generation
- Goose Migration
  - Migration creation
...
**8. Security Package Integration**
- `SecureString` type with automatic encryption/decryption
- GORM hooks for transparent database encryption
- JSON redaction for sensitive data logging prevention

**9. Crypto Package Integration**
- `Encrypter` interface scaffolding
- AES-GCM encryption implementation
- Blind index computation for searchable encryption
- Mock encrypter for testing

**10. JWT Helper Package Integration**
- RSA asymmetric key JWT generation
- Token parsing and validation utilities
- Configuration for key file paths and algorithms
- Claims management helpers

**11. Log Package Integration**
...
- Build optimization for Go binaries
- Private repository support with SSH keys
- Environment-specific configurations

**13. Docker Ignore Generation**
...
**17. Makefile Generation**
- Common development commands
- Build, test, and run targets
- Docker and deployment shortcuts
